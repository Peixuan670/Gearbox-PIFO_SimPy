...
class Pkt_mon(HW_sim_object):
    def __init__(self, env, line_clk_period, sys_clk_period, pkt_out_pipe, drop_pipe, mon_info_pipe, pkt_mon_rdy, verbose):
    ...
    def pkt_mon_sm(self):
        ...
        print ("Number of dropped packets = {}".format(self.drop_cnt))