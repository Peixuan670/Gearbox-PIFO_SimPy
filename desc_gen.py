...
class Desc_gen(HW_sim_object):
    def __init__(self, env, line_clk_period, sys_clk_period, base_file_name, pcap_desc_pipe, mon_info_pipe, rate_tuple_list):
    ...
    def run(self):
        self.env.process(self.process_desc(self.f_desc, self.rate_tuple_list))
        
    def process_desc(self, f_desc, rate_tuple_list):
